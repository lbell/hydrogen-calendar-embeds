...
function pcemb_register_frontend_css() {
  ...
  // wp_register_style('fullcalendar', 'https://cdn.jsdelivr.net/npm/fullcalendar@6/index.global.min.css', null, PCEMB_VER);
...
function pcemb_register_frontend_js() {
  // 3rd Party CDN alternatives (for reference):
  // wp_register_script('fullcalendar', 'https://cdn.jsdelivr.net/npm/fullcalendar@6/index.global.min.js', null, PCEMB_VER, true);
